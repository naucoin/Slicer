...
#ifndef __qMRMLMarkupsRulerProjectionPropertyWidgetPlugin_h
#define __qMRMLMarkupsRulerProjectionPropertyWidgetPlugin_h
...
public:
  qMRMLMarkupsRulerProjectionPropertyWidgetPlugin(QObject *_parent = 0);
