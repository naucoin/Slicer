...
public slots:
  ...
  void onRulerLabelPositionSliderWidgetChanged(double value);
  void onRulerTickSpacingMRMLSliderWidgetChanged();
  void onRulerMaxNumberOfTicksSliderWidgetChanged(double value);
