...
#ifndef __qSlicerMarkupsToolBar_p_h
#define __qSlicerMarkupsToolBar_p_h
...
class qSlicerMarkupsToolBarPrivate: public QObject
{
  Q_OBJECT
  QVTK_OBJECT
  Q_DECLARE_PUBLIC(qSlicerMarkupsToolBar);

protected:
  qSlicerMarkupsToolBar* const q_ptr;

public:
  qSlicerMarkupsToolBarPrivate(qSlicerMarkupsToolBar& object);

  void init();
  void setMRMLScene(vtkMRMLScene* newScene);
  void updateWidgetFromMRML();
  void updateWidgetFromSelectionNode();
  /// given a markup id, find the action associated with it and set it
  /// checked, update the cursor, update the icon on the button
  void updateWidgetToMarkups(const char *markupsID);
...
public slots:
  ...
  void onActiveMarkupsNodeTypeChangedEvent();
  void onMarkupsIDListModifiedEvent();
